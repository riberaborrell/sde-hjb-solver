...
from sde_hjb_solver.hjb_solver_1d_det import SolverHJB1DDet
...
def main():
    ...
    from sde_hjb_solver.functions import linear
    x = 2
    a = 1
    b = -1
    y = linear(x, a, b)
    ...
    # initialize hjb solver
    sol_hjb = SolverHJB1DDet(sde, h=args.h, dt=0.01, T=1.)

    #sde.compute_mfht()

    # compute hjb solution 
    sol_hjb.solve_bvp_det()
    breakpoint()
